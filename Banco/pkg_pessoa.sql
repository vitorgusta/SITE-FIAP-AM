create or replace package pkg_pessoa is 
  ...
  procedure prc_insere(p_nome go_pessoa.nome_completo%type,p_end go_pessoa.endereco%type,p_email go_pessoa.email%type, p_data_nascimento go_pessoa.data_nascimento%type, p_usuario go_pessoa.usuario%type, p_senha go_pessoa.senha%type);
