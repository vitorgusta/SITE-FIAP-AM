create or replace package pkg_categoria is  
  ...
  procedure prc_insere (p_categoria go_categoria.categoria%type, p_sta_ativo go_categoria.sta_ativo%type);
  
  procedure prc_altera (p_id go_categoria.id%type, p_categoria go_categoria.categoria%type, p_sta_ativo go_categoria.sta_ativo%type,p_usuario go_pessoa.usuario%type);
  
  procedure prc_deleta (p_id go_categoria.id%type,p_usuario go_pessoa.usuario%type);

end pkg_categoria;
/
create or replace package body pkg_categoria is 
  
  procedure prc_insere (p_categoria go_categoria.categoria%type, p_sta_ativo go_categoria.sta_ativo%type) is 
  ...
  procedure prc_altera (p_id go_categoria.id%type, p_categoria go_categoria.categoria%type, p_sta_ativo go_categoria.sta_ativo%type,p_usuario go_pessoa.usuario%type) is 
 ...
 procedure prc_deleta (p_id go_categoria.id%type,p_usuario go_pessoa.usuario%type) is
